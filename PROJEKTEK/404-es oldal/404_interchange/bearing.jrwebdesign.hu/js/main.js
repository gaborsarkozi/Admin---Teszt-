...
$(document).ready(function() {
    ...
    /*$(".info_icon_product").on("click", function () {
		...
		//runtabs();
		$.get("/Utojelek/getUtojel", { gyarto : gyarto, isUtojel : "1" }, function(data) {
    ...
    $(".info_icon_product").on("click", function() {
        autoclose();
        $(".dialog_box").html('<div id="dialog-similar-product" title="6304 2R S"> <div id="tabs"> <div class="before-table"><a class="active-link elotag-tab" href="#">Előtag</a><a class="utojel-tab" href="#">Utójel</a></div><div id="tabs-1" class="table-box"> <table class="elotag" width="100%"> <thead> <th width="235px"><input type="text"></th> <th width="195px"><select> <option selected="true" disabled="disabled">NIS/Y</option> <option>BEX</option> <option>BLT</option> <option>FAG</option> <option>FBJ</option> <option>INA</option> <option>KOYO</option> <option>NACHI</option> <option>NIS/Y</option> </select></th> <th width="290px" class="hide-mobil"><select> <option selected="true" disabled="disabled">Típus</option> <option>Csapágyegységek</option> <option>Golyóscsapágyak</option> <option>Görgőscsapágyak</option> <option>Precíziós ferdehatásvonalú golyóscsapágyak</option> </select></th> <th width="305px"><select> <option selected="true" disabled="disabled">Amire vonatkozik</option> <option>Anyag</option> <option>Szerkezet</option> <option>Méret</option> <option>Egyéb</option> </select></th> <th width="440px">Mit jelent</th> <th width="150px" class="hide-tablet">Kép</th> </thead> <tr> <td>4T</td><td>RHP<br>TIM<br>BEX CX<br>FBJ<br>NACHI<br>NIS/Y<br>SKF<br>SNR</td><td class="hide-mobil">Kúpgörgős csapágyak</td><td>Anyag</td><td class="lowercase">edzett acélból készült kúpgörgős csapágy</td><td class="hide-tablet"><img src="../image/table_image.jpg" alt=""></td></tr><tr> <td>EC</td><td>RHP<br>TIM<br>BEX CX<br>FBJ<br>NACHI<br>NIS/Y<br>SKF<br>SNR</td><td class="hide-mobil">Golyóscsapágyak</td><td>Szerkezet</td><td class="lowercase">hőtágulási kompenzációval rendelkező csapágyak</td><td class="hide-tablet"></td></tr></table> </div><div id="tabs-2" class="table-box hide"> <table class="elotag" width="100%"> <thead> <th width="235px"><input type="text"></th> <th width="195px"><select> <option selected="true" disabled="disabled">Gyártó</option> <option>BEX</option> <option>BLT</option> <option>FAG</option> <option>FBJ</option> <option>INA</option> <option>KOYO</option> <option>NACHI</option> <option>NIS/Y</option> </select></th> <th width="290px" class="hide-mobil"><select> <option selected="true" disabled="disabled">Típus</option> <option>Csapágyegységek</option> <option>Golyóscsapágyak</option> <option>Görgőscsapágyak</option> <option>Precíziós ferdehatásvonalú golyóscsapágyak</option> </select></th> <th width="305px"><select> <option selected="true" disabled="disabled">Amire vonatkozik</option> <option>Anyag</option> <option>Szerkezet</option> <option>Méret</option> <option>Egyéb</option> </select></th> <th width="440px">Mit jelent</th> <th width="150px" class="hide-tablet">Kép</th> </thead> <tr> <td>C3</td><td>FBJ</td><td class="hide-mobil">Golyóscsapágyak</td><td></td><td class="lowercase">a csapágy radiális hézaga nagyobb, mint a normál</td><td class="hide-tablet"><img src="../image/table_image.jpg" alt=""></td></tr><tr> <td>2RS</td><td>FBJ</td><td class="hide-mobil">Golyóscsapágyak</td><td>Szerkezet</td><td class="lowercase">két oldalt gumi porvédővel zárt</td><td class="hide-tablet"></td></tr></table> </div></div></div>');
        //runtabs();
        //eloTag();
        //utoJel();
        rundialog();
